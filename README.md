...
Install the schemes:
> net install schemes, from("https://github.com/asjadnaqvi/The-Stata-schemes/raw/master/schemes")

You can try various graphs either using this test data set:
> use "https://github.com/asjadnaqvi/The-Stata-schemes/blob/master/schemes/scheme_test.dta?raw=true", clear
